...
#' It uses the machine learning models available in the caret package. To create replicable examples, use
#' the function together with set.seed().
#'
...
#' available in the caret package. To create replicable examples, use the
#' function together with set.seed().
#'
...
#' To create replicable examples, use the function together with set.seed().
#'
