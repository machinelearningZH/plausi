...
# Install "swissdd"-package to load vote-results from opendata.swiss
...
diff1 <- get_differences(data_wide, combinations$V1, combinations$V2, geo_cols = c("canton_name", "mun_name", "mun_id"))
